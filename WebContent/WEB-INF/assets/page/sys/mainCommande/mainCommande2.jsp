			...
			<div id="toolbar">
				<table>
					<tr>
						...
						<td><div class="datagrid-btn-separator"></div></td>
						<td><a href="javascript:initSt();" class="easyui-linkbutton"
							data-options="iconCls:'icon-remove',plain:true"> 强制删除</a></td>
					</tr>
				</table>
			</div>
		</div>
					...
					<form id="fm" method="post" novalidate>
						...
						<div class="fitem">
							<label> <spr:message code='mCommande.obj.customer' />:
								...
								id="c3" /> <a href="javascript:;" onclick="MC.openFmCus()">新增用户</a>&nbsp;&nbsp;<a
								href="javascript:;" onclick="MC.openSrcCus()">筛选用户</a>
						</div>
						<div class="fitem">
