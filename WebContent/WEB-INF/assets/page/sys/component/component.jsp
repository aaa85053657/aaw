...
<title><spr:message code='component.page.title' /></title>
<jsp:include page="../../base/head2.jsp" />
<script type="text/javascript" src="static/js/col/ComponentCol.js"></script>
<script type="text/javascript"
	src="static/js/validator/ComponentValidator.js"></script>
<script type="text/javascript" src="static/js/opr/Component.js"></script>
</head>
<body>
	<table id="tt"></table>
	<div id="toolbar">
	...
	<div>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				<div>
					<label><spr:message code='component.obj.codeID' />:</label> <input
						name="codeId" class="easyui-textbox"
						data-options="required:true,validType:['codeID']" />
				</div>
				<div>
					<label><spr:message code='component.obj.name' />: </label> <input
						name="name" class="easyui-textbox"
						data-options="required:true,validType:['name']" />
				</div>
				<div>
					<label><spr:message code='component.obj.comments' />:</label>
