...
public class LogExceptionCtl extends BaseCtl<LogException> {
	...
	public ModelAndView view() {
		return new ModelAndView("sys/exception/exceptionLog");
	}
	...
	public Object list(@RequestParam(defaultValue = "1") int page,
		...
		try {
			...
			log.error("LogExceptionCtl列表查询异常", e);
		}
		return null;
	}
...
//	@ResponseBody
//	public Object save(LogException bean, HttpServletRequest request) {
//		try {
//			service.save(bean);
//			return saveSuc(request);
//		} catch (Exception e) {
//			log.error("LogExceptionCtl保存对象异常", e);
//		}
...
//	@ResponseBody
//	public Object update(LogException bean, HttpServletRequest request) {
//		try {
//			service.update(bean);
//			return suc("修改成功");
//		} catch (Exception e) {
//			log.error("LogExceptionCtl修改对象异常", e);
//		}
//		return err("修改异常");
//	}
//
...
//			return suc("删除成功");
//		} catch (Exception e) {
//			log.error("LogExceptionCtl通过ID删除对象异常", e);
//		}
//		return err("删除异常");
//	}
